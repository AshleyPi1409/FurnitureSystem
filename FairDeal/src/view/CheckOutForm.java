...
public final class CheckOutForm extends javax.swing.JInternalFrame {
    ...
    OrderEntityManager billModel = new OrderEntityManager();
    ...
    public CheckOutForm() {
        ...
        txtSeller.setText(EmployeeEntityManager.currentAccount.getUsername());
...
//            cbbProduct.addItem(pro.getName());
    ...
    private void initComponents() {
        ...
        pnlSeller.add(jLabel5, gridBagConstraints);
        ...
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.insets = new java.awt.Insets(10, 10, 10, 10);
        pnlCustomer.add(jLabel6, gridBagConstraints);

        txtCustomer.setMinimumSize(new java.awt.Dimension(200, 20));
        txtCustomer.setPreferredSize(new java.awt.Dimension(200, 20));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.insets = new java.awt.Insets(10, 10, 10, 10);
        pnlCustomer.add(txtCustomer, gridBagConstraints);
        ...
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.insets = new java.awt.Insets(10, 10, 10, 10);
        pnlDate.add(jLabel7, gridBagConstraints);
        ...
        pnlCart.setMinimumSize(new java.awt.Dimension(400, 300));
        pnlCart.setPreferredSize(new java.awt.Dimension(400, 300));
        ...
        pnlProduct.setMinimumSize(new java.awt.Dimension(400, 300));
        pnlProduct.setPreferredSize(new java.awt.Dimension(400, 300));
        pnlProduct.setLayout(new java.awt.GridBagLayout());

        jScrollPane1.setMinimumSize(new java.awt.Dimension(360, 230));
        jScrollPane1.setPreferredSize(new java.awt.Dimension(360, 230));
    ...
    private void btnSubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubmitActionPerformed
        ...
        bill.setAccount(EmployeeEntityManager.currentAccount);
