...
//                    txtImportDate.setText(tblProduct.getValueAt(selectedIndex, 1).toString());
    ...
    private void initComponents() {
        ...
        pnlInputPrice = new javax.swing.JPanel();
        pnlFieldPrice = new javax.swing.JPanel();
        ...
        pnlButtonPrice = new javax.swing.JPanel();
        ...
        pnlInput.setMinimumSize(new java.awt.Dimension(665, 270));
        pnlInput.setName(""); // NOI18N
        pnlInput.setPreferredSize(new java.awt.Dimension(665, 270));
        ...
        pnlField.add(jLabel1, gridBagConstraints);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.LINE_START;
        gridBagConstraints.insets = new java.awt.Insets(10, 15, 10, 10);
        pnlField.add(jLabel2, gridBagConstraints);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.LINE_START;
        gridBagConstraints.insets = new java.awt.Insets(10, 15, 10, 10);
        pnlField.add(jLabel3, gridBagConstraints);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.LINE_START;
        gridBagConstraints.insets = new java.awt.Insets(10, 15, 10, 10);
        pnlField.add(jLabel4, gridBagConstraints);
        ...
        pnlField.add(jLabel5, gridBagConstraints);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.LINE_START;
        gridBagConstraints.insets = new java.awt.Insets(10, 20, 10, 20);
        pnlField.add(jLabel6, gridBagConstraints);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.LINE_START;
        gridBagConstraints.insets = new java.awt.Insets(10, 20, 10, 20);
        pnlField.add(jLabel8, gridBagConstraints);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.LINE_START;
        gridBagConstraints.insets = new java.awt.Insets(10, 20, 10, 20);
        pnlField.add(jLabel9, gridBagConstraints);
        ...
        pnlField.add(txtId, gridBagConstraints);
        ...
        gridBagConstraints.gridy = 2;
        gridBagConstraints.insets = new java.awt.Insets(5, 15, 5, 15);
        pnlField.add(txtDes, gridBagConstraints);
        ...
        gridBagConstraints.gridy = 0;
        gridBagConstraints.insets = new java.awt.Insets(5, 15, 5, 15);
        pnlField.add(txtQuantity, gridBagConstraints);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.LINE_START;
        gridBagConstraints.insets = new java.awt.Insets(5, 15, 5, 15);
        pnlField.add(cbbCategory, gridBagConstraints);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.LINE_START;
        gridBagConstraints.insets = new java.awt.Insets(5, 15, 5, 15);
        pnlField.add(cbbPublisher, gridBagConstraints);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.LINE_START;
        gridBagConstraints.insets = new java.awt.Insets(5, 15, 5, 15);
        pnlField.add(cbbUnit, gridBagConstraints);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 3;
        ...
        pnlButton.add(btCreateProduct, gridBagConstraints);
        ...
        gridBagConstraints.gridy = 4;
        gridBagConstraints.insets = new java.awt.Insets(10, 15, 5, 15);
        pnlButton.add(btUpdateProduct, gridBagConstraints);
        ...
        gridBagConstraints.gridy = 4;
        gridBagConstraints.insets = new java.awt.Insets(10, 15, 5, 15);
        pnlButton.add(btDeleteProduct, gridBagConstraints);
        ...
        gridBagConstraints.gridy = 4;
        gridBagConstraints.insets = new java.awt.Insets(10, 15, 5, 15);
        pnlButton.add(btResetProduct, gridBagConstraints);
        ...
        pnlOutput.setMinimumSize(new java.awt.Dimension(665, 270));
        pnlOutput.setPreferredSize(new java.awt.Dimension(665, 270));
        pnlOutput.setLayout(new java.awt.GridBagLayout());

        jScrollPane1.setMinimumSize(new java.awt.Dimension(600, 170));
        jScrollPane1.setPreferredSize(new java.awt.Dimension(600, 170));
        ...
        pnlOutput.add(jButton1, gridBagConstraints);
        ...
        pnlInputPrice.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEtchedBorder(), "Price Control"));
        pnlInputPrice.setMinimumSize(new java.awt.Dimension(360, 270));
        pnlInputPrice.setPreferredSize(new java.awt.Dimension(360, 270));
        pnlInputPrice.setLayout(new java.awt.GridBagLayout());

        pnlFieldPrice.setLayout(new java.awt.GridBagLayout());
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.LINE_START;
        gridBagConstraints.insets = new java.awt.Insets(10, 20, 10, 20);
        pnlFieldPrice.add(jLabel11, gridBagConstraints);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.LINE_START;
        gridBagConstraints.insets = new java.awt.Insets(10, 20, 10, 20);
        pnlFieldPrice.add(jLabel13, gridBagConstraints);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.LINE_START;
        gridBagConstraints.insets = new java.awt.Insets(10, 20, 10, 20);
        pnlFieldPrice.add(jLabel14, gridBagConstraints);
        ...
        pnlFieldPrice.add(txtPriceID, gridBagConstraints);
        ...
        gridBagConstraints.gridwidth = 3;
        gridBagConstraints.insets = new java.awt.Insets(5, 10, 5, 10);
        pnlFieldPrice.add(txtPriceValue, gridBagConstraints);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.LINE_START;
        gridBagConstraints.insets = new java.awt.Insets(10, 20, 10, 20);
        pnlFieldPrice.add(jLabel12, gridBagConstraints);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.LINE_START;
        gridBagConstraints.insets = new java.awt.Insets(10, 20, 10, 20);
        pnlFieldPrice.add(jLabel15, gridBagConstraints);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 2;
        gridBagConstraints.gridwidth = 3;
        ...
        pnlFieldPrice.add(jxdStartDate, gridBagConstraints);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 3;
        gridBagConstraints.gridwidth = 3;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        gridBagConstraints.insets = new java.awt.Insets(0, 10, 0, 0);
        pnlFieldPrice.add(jxdEndDate, gridBagConstraints);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 4;
        gridBagConstraints.gridwidth = 3;
        ...
        pnlFieldPrice.add(cbbProduct, gridBagConstraints);

        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 0;
        gridBagConstraints.gridwidth = 3;
        pnlInputPrice.add(pnlFieldPrice, gridBagConstraints);

        pnlButtonPrice.setLayout(new java.awt.GridBagLayout());
        ...
        pnlButtonPrice.add(btnCreatePrice, gridBagConstraints);
        ...
        gridBagConstraints.gridy = 0;
        gridBagConstraints.insets = new java.awt.Insets(10, 10, 0, 0);
        pnlButtonPrice.add(btnUpdatePrice, gridBagConstraints);
        ...
        gridBagConstraints.gridy = 0;
        gridBagConstraints.insets = new java.awt.Insets(10, 10, 0, 0);
        pnlButtonPrice.add(btnDeletePrice, gridBagConstraints);

        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.gridwidth = 3;
        pnlInputPrice.add(pnlButtonPrice, gridBagConstraints);

        getContentPane().add(pnlInputPrice, new java.awt.GridBagConstraints());
        ...
        jScrollPane2.setMinimumSize(new java.awt.Dimension(300, 220));
        jScrollPane2.setPreferredSize(new java.awt.Dimension(300, 220));
    ...
    private javax.swing.JPanel pnlButtonPrice;
    private javax.swing.JPanel pnlField;
    private javax.swing.JPanel pnlFieldPrice;
    private javax.swing.JPanel pnlInput;
    private javax.swing.JPanel pnlInputPrice;
